...
export default function Header() {
  ...
  return (
    <header className="header">
      ...
      {/* Mobile Nav */}
      {isOpen && (
        <div className="mobile-menu md:hidden bg-white absolute top-[80px] left-0 w-full shadow-lg p-4 flex flex-col gap-4 z-50">
          <a href="#projects" className="nav-link">Design Ideas</a>
          <a href="#projects" className="nav-link">Projects</a>
          <a href="#magazine" className="nav-link">Magazine</a>
          ...
          <a href="#" className="text-secondary font-semibold">Join as Partner</a>
